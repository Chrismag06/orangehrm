...
class SearchEmployee(unittest.TestCase):
    ...
    def test_search_employee(self):
        ...
        driver.find_element(By.XPATH, "//div[@id='app']/div/div[2]/div[2]/div/div/div[2]/form/div/div/div/div/div[2]/div/div/input").send_keys("UserPPPP")
        driver.find_element(By.XPATH, "//button[@type='submit']").click()

        resultat_rechercher = driver.find_element(By.XPATH, "//*[@id='app']/div[1]/div[2]/div[2]/div/div[2]/div[2]/div/span").text

        print(f"resultat ====>", resultat_rechercher.find("No"))

        assert resultat_rechercher.find("No") == "-1", "Pas de résultat hélas"
